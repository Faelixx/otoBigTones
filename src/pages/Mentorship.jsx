...
const Mentorship = () => {
  ...
  return (
    <div>
      ...
      <section>
        <h1 data-aos='fade-up' data-aos-delay='50' data-aos-duration='1250' className='text-amber-400 text-center text-8xl'>Mentorship</h1>
        <div data-aos='fade-up' data-aos-delay='50' data-aos-duration='1250' className='flex flex-col justify-center'>
        <p data-aos='fade-up' data-aos-delay='50' data-aos-duration='1250' className='text-justify my-4 mx-4 md:mx-10 lg:mx-[15vw] text-xl text-white'>Big Tones has worked as an artist mentor with the Community Arts Mentorship Program, Paved Arts, Creative City Centre Regina, LIVE Arts and Kilburn Hall. Big Tones offers a variety of workshops that blend culture, traditional drumming and Hip Hop for the youth to experience music and take culture back while doing so. Big Tones has worked as an artist mentor in many communities including: Beardy’s and Okemasis’, Buffalo Narrows, Beauval, Stanley Mission, Grandmother’s Bay, Hall Lake, Lac La Ronge, Sucker River, Little Red River, and Hatchet Lake.</p>

        </div>

        <div data-aos='fade-up' data-aos-delay='50' data-aos-duration='1250' className='flex flex-col items-center justify-center'>
          <img data-aos='fade-up' data-aos-delay='50' data-aos-duration='1250' className='sm:h-[225px] sm:w-[1000px] lg:h-96 md:w-[70vw] object-cover object-[center_43%] sm:mx-4 md:mx-20' src={headerImage} alt='Big Tones with Drayden holding drums'></img>
          <br></br>
      ...
      > 
        {
            ...
            mentorshipItems.map((item) => 
              <>
              <SwiperSlide>
              <div data-aos='fade-up' data-aos-delay='50' data-aos-duration='1250' className='flex flex-col items-center justify-center my-2'>
                <img data-aos='fade-up' data-aos-delay='50' data-aos-duration='1250' className='sm:h-[225px] sm:w-[1000px] md:h-96 md:w-[70vw] object-cover object-[center_43%]' src={item.image} alt={item.caption} />
