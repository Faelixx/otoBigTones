  ...
  return (
    <div className='flex flex-col items-center justify-items-center'>
      <section className='min-w-full'>
        {Viewport().width > 640 ? 
        <div data-aos='fade-up' data-aos-delay='50' data-aos-duration='1250' className='mb-[-40px]'>
          <img data-aos='fade-up' data-aos-delay='50' data-aos-duration='1250' className='object-cover max-h-48 min-w-full
      ...
      <section className='translate-y-[-2rem] flex flex-col items-center justify-items-center'>
        <h2 data-aos='fade-up' data-aos-delay='50' data-aos-duration='1250' className='text-4xl text-amber-400'>Watch Open Ya Eyez From Existence</h2>
        <div data-aos='fade-up' data-aos-delay='50' data-aos-duration='1250'>
        ...
        <h2 data-aos='fade-up' data-aos-delay='50' data-aos-duration='1250' className='text-amber-400 text-2xl pt-6'>Stream Existence on Spotify</h2>
        <div data-aos='fade-up' data-aos-delay='50' data-aos-duration='1250' className='flex gap-6 flex-row flex items-center lg:flex-row'>
          {Viewport().width < 1024 ? 
        <iframe src="https://open.spotify.com/embed/album/5PXO2ZJvGOTluyBmv6P2PD?utm_source=generator" width="350" height="160" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe> : 
          <div data-aos='fade-up' data-aos-delay='50' data-aos-duration='1250' className='flex flex-row gap-6'>
            <img data-aos='fade-up' data-aos-delay='50' data-aos-duration='1250' className='object-cover w-80 h-[9.5rem] rounded-xl' src={BigTonesAlbumArt} alt='OTO Big Tones Album Art' />
            <iframe src="https://open.spotify.com/embed/album/5PXO2ZJvGOTluyBmv6P2PD?utm_source=generator" width="350" height="160" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
          </div>
          }
        </div>
      ...
      <section>
        <h1 data-aos='fade-up' data-aos-delay='50' data-aos-duration='1250' className='text-amber-400 text-2xl pt-2 pb-2 text-center'>More <a href='/videos' className='underline'>Videos</a> By Big Tones</h1>
        <div data-aos='fade-up' data-aos-delay='50' data-aos-duration='1250'>
